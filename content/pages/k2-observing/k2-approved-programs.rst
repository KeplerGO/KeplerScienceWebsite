...
.. include:: approved-programs/c19.html
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
      <a href="data/campaigns/c15/K2Campaign15targets.csv">Target list (csv)</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-external-link fa-margin"></i>
...
.. raw:: html
    ...
    <p>
    The Campaign 13 target list includes <b>21,434 standard long cadence</b> and <b>109 standard short cadence</b> targets,
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-pencil-square-o fa-margin"></i>
      <a href="k2-data-release-notes.html#k2-campaign-13">Data release notes</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
    ...
    <li class="list-group-item">
      <i class="fa fa-external-link fa-margin"></i>
      <a href="https://archive.stsci.edu/pub/k2/target_pixel_files/c13">Target pixel files (MAST)</a>
    </li>
  </ul>
...
.. raw:: html
    ...
    <p>
    The Campaign 12 target list includes <b>29,221 standard long cadence</b> and <b>141 standard short cadence</b> targets,
  ...
  <ul class="list-group">
    <li class="list-group-item">
      <i class="fa fa-calendar fa-margin"></i>
      Dec 15, 2016 - Mar 4, 2017
    </li>
    <li class="list-group-item">
      <i class="fa fa-pencil-square-o fa-margin"></i>
      <a href="k2-data-release-notes.html#k2-campaign-12">Data release notes</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
      <a href="data/campaigns/c12/K2Campaign12targets.csv">Target list (csv)</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-external-link fa-margin"></i>
      <a href="https://archive.stsci.edu/pub/k2/target_pixel_files/c12">Target pixel files (MAST)</a>
    </li>
  </ul>
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-pencil-square-o fa-margin"></i>
      <a href="k2-data-release-notes.html#k2-campaign-11">Data release notes</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-pencil-square-o fa-margin"></i>
      <a href="k2-data-release-notes.html#k2-campaign-10">Data release notes</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-pencil-square-o fa-margin"></i>
      <a href="k2-data-release-notes.html#k2-campaign-8">Data release notes</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-cog fa-margin"></i>
      <a href="/k2-pipeline-release-notes.html#data-release-11">Pipeline: 9.3</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
      <a href="data/campaigns/c5/K2Campaign5targets.csv">Target list (csv)</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-external-link fa-margin"></i>
...
.. raw:: html
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      <i class="fa fa-download fa-margin"></i>
      <a href="data/campaigns/c4/K2Campaign4targets.csv">Target list (csv)</a>
    </li>
    <li class="list-group-item">
      <i class="fa fa-external-link fa-margin"></i>
