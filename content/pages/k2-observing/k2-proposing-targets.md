...
Step-1 proposals consisting of a brief scientific justification and
targets lists that are submitted in response to the K2 GO Cycle 6 call
will be evaluated primarily on the scientific merit and the long-term
legacy value in observing the proposed targets. The Step-1 proposals
will be peer-reviewed and will support target selection for the
campaigns to be observed in Cycle 6.

Step-2 proposals submitted via NSPIRES in response the K2 GO Cycle 6 call will be evaluated 
...
All Step-2 proposals are peer-reviewed and ranked by a panel of professional volunteers, followed by ratification from NASA Headquarters. The members of the peer-review panel will not be disclosed. The deliberations of the panel will be disclosed to PIs only after ratification by the selecting official.
...
In K2 GO Cycle 6, only Step-2 proposals are considered for funding.
...
K2fov to the latest version (v7.1.1) to take the final field positions of Campaigns 17-18-19 into account. 
...
This must return "7.1.1" or higher. If the number is lower,
...
Target tables for each campaign are required to be submitted via email directly to the
Kepler & K2 GO Office for Step-1
proposals submitted in response to GO Cycle 6. They do not need to
be embedded within the text of the proposal.

For GO Cycle 6 Step-2 proposals that are submitted via NSPIRES in order to request funding, a target table
for each campaign must appear in two places:
...
3.  Copy / paste or encapsulate the table into the submission package
    ...
    and the PI's biography (only required for Step-2 proposals).
...
[released and made available at NSPIRES](https://nspires.nasaprs.com/external/solicitations/summary!init.do?solId={7DC22936-4C6A-44FC-74A3-F0C9248DC9DD}&path=open). Due to the uncertainty in the estimated spacecraft fuel available for the K2 Mission, which under normal operational conditions, suggest a depletion in the near future, we are presenting a different proposal submission and target selection process for K2 Cycle 6, which comprises Campaigns 17, 18, and 19. We
are requesting the community propose targets to observe
during only these three campaigns. Note that C17 and C19 involve the Kepler spacecraft observing in the forward-facing direction.  We strongly encourage programs that can
...
Step-1 proposals for Cycle 6 are due October 12, 2017 by 23:59 (EDT). <br/>
Step-2 proposals for Cycle 6 are due April 19, 2018 by 23:59 (EDT).
...
href="k2-fields.html">fields page.</a> All investigators *must* update their version of the
...
* **Should I submit one proposal or two?**<br/>
  ...
  campaigns, please provide one science justification and up to three target tables, one for each field.<br/>
...
spacecraft fuel available. Target lists and accompanying scientific justifications for these campaigns are now required to be submitted as part of a Step-1 submission, which was not required in prior K2 Cycles. The Step-1 submission is designed to enable targets to be selected via peer review ahead of these campaigns, allowing the Step-2 deadline for funding proposals to be postponed until after the successful start of Campaign 17 is confirmed.

To propose specific targets to be observed in Campaigns 17, 18, and/or
19, investigators are
required to submit Step-1 proposals via email directly to the GO Office by <font color='red'>23:59 EDT
October 12, 2017</font>. A Step-1 submission is encouraged, but not mandatory, to qualify for Step-2.
...
required to submit Step-2 proposals through the NSPIRES website by <font color='red'>23:59 EDT
April 19, 2018</font>. All proposers need to register
with NSPIRES in order to submit a Step-2 proposal. Note that Step-2
...
**Detailed instructions for submitting a Step-1 proposal are provided below:**
...
* Submit a Step-1 proposal (one PDF document) and all relevant target
...
**Detailed instructions for submitting a Step-2 proposal are provided below:**

* Step-2 proposals and accompanying target tables must only include
  targets that have been selected as part of Step-1, the selection
...
* [Submit a Step-2 proposal to NSPIRES](http://nspires.nasaprs.com/external/)
...
In summary, proposers should:
  ...
  * Develop and justify a science concept for observations
   ...
   * For Step-2 proposals only, provide the administrative elements of the proposal
          including a proposer biographical information, and a
          statement of current and pending financial support.
   * **For Step-2 proposals only, large proposals that anticipate delivery of a data product/products
...
During the submission process for Step-2 proposals via NSPIRES, non-US PI-led proposals will need to be
