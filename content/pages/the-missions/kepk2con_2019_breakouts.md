...
<p><b>Attendee needs:</b> laptop with R already installed (download from
  <a href=https://www.r-project.org/ target="_blank">https://www.r-project.org/</a>); attendees should also download the contents of the folder
  <a href=https://tinyurl.com/y9zubfjr target="_blank">Kepler-R Feigelson</a> on Google drive into an empty local directory.  This folder has datasets and an R script.  The script is available as a stand-alone and embedded in a Jupyter notebook.  Graphical and tabular output will be generated.</p>
