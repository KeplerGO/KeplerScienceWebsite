...
*	Kelsey	Hoffman	,	SETI
*	Bradford	Holden	,	Univ. of CA Observatories
*	Andrew	Howard	,	Caltech
*	Danley	Hsu	,	Pennsylvania State University
*	Daniel	Huber	,	Institute for Astronomy, University of Hawaii
*	Douglas	Hudgins	,	NASA Headquarters
*	Kai	Ikuta	,	Kyoto University
*	Heshan	Illangkoon	,	Blue Marble Space Institute of Science
*	Howard	Isaacson	,	Univeristy of California, Berkeley
...
*	Andrew	Mayo	,	Harvard University
...
*	Kadri Bin	Mohamad Nizam	,	University of the Pacific
...
*	Gerald	Nordley	,	CONTACT: Cultures of the Imagination
...
*	Jennifer	van Saders	,	Carnegie Observatories
*	Andrew	Vanderburg	,	Harvard-Smithsonian Center for Astrophysics
*	Roland	Vanderspek	,	MIT
*	Laura D.	Vega	,	Vanderbilt University
*	Mathieu	Vrard	,	Instituto de Astrophísica e ciências do espaço (IA), Porto, Portugal
*	Stephen	Walker	,	NASA
*	Ji	Wang	,	Caltech
*	Songhu	Wang	,	Yale
