...
The database contains 3084 publications,
of which 2749 are peer-reviewed.
...
of year and mission.
The publication count for Kepler is 2538
while that of K2 is 546.
The number of refereed papers is 2272 for Kepler and 477 for K2.
...
by a total of 5223 unique author names.
...
While 1456 works relate to exoplanets
(47%),
a total of 1628
...
<span class="badge">1514 citations</span>
...
<span class="badge">785 citations</span>
...
<span class="badge">716 citations</span>

4. CHARACTERISTICS OF PLANETARY CANDIDATES OBSERVED BY KEPLER. II. ANALYSIS OF THE FIRST FOUR MONTHS OF DATA  
Borucki, William J., Koch, David G., Basri, Gibor, et al.    
[2011ApJ...736...19B](http://adsabs.harvard.edu/abs/2011ApJ...736...19B)
<span class="badge">691 citations</span>

5. KEPLER MISSION DESIGN, REALIZED PHOTOMETRIC PERFORMANCE, AND EARLY SCIENCE  
Koch, David G., Borucki, William J., Basri, Gibor, et al.    
[2010ApJ...713L..79K](http://adsabs.harvard.edu/abs/2010ApJ...713L..79K)
<span class="badge">665 citations</span>

6. THE K2 MISSION: CHARACTERIZATION AND EARLY RESULTS  
Howell, Steve B., Sobeck, Charlie, Haas, Michael, et al.    
[2014PASP..126..398H](http://adsabs.harvard.edu/abs/2014PASP..126..398H)
<span class="badge">650 citations</span>
...
<span class="badge">604 citations</span>
...
<span class="badge">567 citations</span>

9. KEPLER INPUT CATALOG: PHOTOMETRIC CALIBRATION AND STELLAR CLASSIFICATION  
Brown, Timothy M., Latham, David W., Everett, Mark E., et al.    
[2011AJ....142..112B](http://adsabs.harvard.edu/abs/2011AJ....142..112B)
<span class="badge">564 citations</span>
...
<span class="badge">539 citations</span>

11. HABITABLE ZONES AROUND MAIN-SEQUENCE STARS: NEW ESTIMATES  
Kopparapu, Ravi Kumar, Ramirez, Ramses, Kasting, James F., et al.    
[2013ApJ...765..131K](http://adsabs.harvard.edu/abs/2013ApJ...765..131K)
<span class="badge">495 citations</span>
...
<span class="badge">396 citations</span>
...
<span class="badge">379 citations</span>

16. OVERVIEW OF THE KEPLER SCIENCE PROCESSING PIPELINE  
...
17. KEPLER'S FIRST ROCKY PLANET: KEPLER-10B  
...
[2012Natur.486..375B](http://adsabs.harvard.edu/abs/2012Natur.486..375B)
<span class="badge">348 citations</span>
...
<span class="badge">346 citations</span>
 ...
 * Balona, L (34 publications)

 * Kipping, D (23 publications)

 * Savanov, I (18 publications)

 * Kjurkchieva, D (15 publications)

 * Jenkins, J (15 publications)

 * Kane, S (14 publications)

 * Borucki, W (13 publications)

 * Murphy, S (13 publications)

 * Scaringi, S (13 publications)

 * Rappaport, S (13 publications)

 * Beck, P (12 publications)

 * Huber, D (12 publications)

 * Baran, A (12 publications)
 ...
 * Vanderburg, A (11 publications)

 * Armstrong, D (11 publications)

 * Heller, R (10 publications)
 ...
 * Corsaro, E (10 publications)

 * David, T (10 publications)
 ...
 * Davenport, J (9 publications)

 * Chaplin, W (9 publications)

 * Plachy, E (9 publications)

 * Zhu, W (9 publications)
 ...
 * Bonomo, A (7 publications)

 * Gilliland, R (7 publications)

 * Diez Alonso, E (7 publications)

 * Kallinger, T (7 publications)
 ...
 * Zeng, L (6 publications)

 * Benomar, O (6 publications)

 * Owen, J (6 publications)

 * Katsova, M (6 publications)
 ...
 * Reinhold, T (6 publications)

 * Carter, J (6 publications)

 * Buldgen, G (6 publications)

 * Dai, F (6 publications)

 * Dong, Y (6 publications)

 * Basri, G (6 publications)

 * Bellinger, E (6 publications)
