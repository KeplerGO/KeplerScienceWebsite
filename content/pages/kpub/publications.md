...
The database contains 906 publications,
of which 857 are peer-reviewed.
...
of year and mission.
The publication count for Kepler is 905
while that of K2 is 1.
The number of refereed papers is 856 for Kepler and 1 for K2.
...
While 436 works relate to exoplanets
(48%),
a total of 470
...
<span class="badge">550 citations</span>
...
<span class="badge">406 citations</span>
...
17. KEPLER ASTEROSEISMOLOGY PROGRAM: INTRODUCTION AND FIRST RESULTS  
...
<span class="badge">275 citations</span>
...
<span class="badge">251 citations</span>
<hr/>
...
by a total of 1994 unique author names.
Here we list the most-active authors, defined as those with six or more first-author publications in our database.


 * Balona, L (16 publications)

 * Borucki, W (12 publications)

 * Jenkins, J (11 publications)

 * Kipping, D (10 publications)

 * Hekker, S (9 publications)

 * Ostensen, R (8 publications)

 * Steffen, J (8 publications)

 * Molenda-Zakowicz, J (8 publications)

 * Huber, D (7 publications)

 * Mosser, B (7 publications)

 * Stello, D (6 publications)

 * Baran, A (6 publications)

 * Koch, D (6 publications)

 * Chaplin, W (6 publications)
