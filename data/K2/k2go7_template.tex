...
%% feasibility to be submitted as part of a K2 GO Cycle 7 Phase 1 proposal.
%% This template is based on the proposal template
%% used by the NuSTAR and TESS missions.
%%
%% K2 GO Cycle 7 template
%% V1.0
%% 2018-08-01
